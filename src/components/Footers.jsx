      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 border-b border-gray-700 pb-10">
        ...
        <div className="gap-2 flex flex-col">
          ...
          <form className="flex">
            <input
              ...
              className="px-3 py-2 rounded-l w-[70%] bg-black border-l border-t border-b border-white outline-none text-white"
            />
            <button
              type="submit"
              className="px-4 py-2 bg-black text-white rounded-r font-bold border-r border-t border-b border-white"
        ...
        <div className="gap-2 flex flex-col">
          ...
          <div className="flex gap-2 mb-3">
            ...
            <img src={QR} alt="App QR" className="h-16 w-16 object-cover" />
