    ...
    appendDots: (dots) => (
      <div
        style={{
          ...
          left: 0,
          right: 0,
          bottom: 24, // place properly inside your frame
          width: "100%",
          display: "flex",
      ...
      {loading ? (
        ...
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pt-10 lg:py-0 lg:border-0 pb-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <form className="hidden lg:block lg:pr-0 lg:border-r lg:border-gray-200 lg:pt-8">
                  ...
                  {filters.map((section) => (
                    ...
                    >
                      <h3 className="-my-3 flow-root lg:pr-4">
