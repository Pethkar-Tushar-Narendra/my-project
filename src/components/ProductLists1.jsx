                ...
                >
                  {products?.map((product, idx) => (
                    <li
                      ...
                      key={product.id}
                      className="inline-flex w-64 flex-col text-start lg:w-60 pb-8 md:pb-0"
                    >
                      <div className="group relative">
                        {/* Discount Badge */}
                        {product.price && product.discounted_price && (
                          <span className="absolute left-2 top-2 bg-red-500 text-xs text-white font-semibold px-2 py-0.5 rounded z-50">
                            -
                            {Math.round(
                              (1 -
                        ...
                        <button className="absolute right-2 z-50 top-2 bg-white rounded-full p-1 transition hover:bg-gray-100">
                          <svg
                        ...
                        <button className="absolute right-2 z-50 top-12 bg-white rounded-full p-1 transition hover:bg-gray-100">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            className="w-5 h-5 text-gray-900"
